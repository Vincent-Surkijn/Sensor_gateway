...
sensor_gateway : main.c connmgr.c datamgr.c sensor_db.c sbuffer.c lib/libdplist.so lib/libtcpsock.so
	...
	gcc -c main.c      -Wall -std=c11 -Werror -DSET_MIN_TEMP=10.0 -DSET_MAX_TEMP=20.0 -DTIMEOUT=5 -o main.o      -fdiagnostics-color=auto
	gcc -c connmgr.c   -Wall -std=c11 -Werror -DSET_MIN_TEMP=10.0 -DSET_MAX_TEMP=20.0 -DTIMEOUT=5 -o connmgr.o   -fdiagnostics-color=auto
	gcc -c datamgr.c   -Wall -std=c11 -Werror -DSET_MIN_TEMP=10.0 -DSET_MAX_TEMP=20.0 -DTIMEOUT=5 -o datamgr.o   -fdiagnostics-color=auto
	gcc -c sensor_db.c -Wall -std=c11 -Werror -DSET_MIN_TEMP=10.0 -DSET_MAX_TEMP=20.0 -DTIMEOUT=5 -o sensor_db.o -fdiagnostics-color=auto
	gcc -c sbuffer.c   -Wall -std=c11 -Werror -DSET_MIN_TEMP=10.0 -DSET_MAX_TEMP=20.0 -DTIMEOUT=5 -o sbuffer.o   -fdiagnostics-color=auto
